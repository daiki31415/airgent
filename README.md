...
> **Note:** Native Windows is not supported. Please run on WSL as Linux.
> The `/copy` command has a file fallback implemented as a safety net for
> native Windows, but it is not CI-verified.
